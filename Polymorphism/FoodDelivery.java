...
class Restaurant {
  ...
  // TODO: Create 'prepareFood()' method that prints "[name] is preparing generic
  // food"
...
class PizzaPlace extends Restaurant {
  ...
  // TODO: Override 'prepareFood()' to print " [name] is making delicious pizza
  // with fresh toppings!"
  @Override
  public void prepareFood() {
...
class SushiBar extends Restaurant {
  ...
  // TODO: Override 'prepareFood()' to print "[name] is crafting fresh sushi with
  // precision!"
  @Override
  public void prepareFood() {
...
public class FoodDelivery {
  public static void main(String[] args) {
    ...
    // The JVM determines the actual object type (PizzaPlace or SushiBar) at runtime
    // and calls the overridden method accordingly.
  }
}
